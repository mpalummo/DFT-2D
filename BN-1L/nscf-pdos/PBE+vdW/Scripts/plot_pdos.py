...
pdos_b1s = np.genfromtxt('hBN_1l_PBE_vdW_DOS.dat.pdos_atm#1(B)_wfc#1(s)',comments="#")
pdos_b1p = np.genfromtxt('hBN_1l_PBE_vdW_DOS.dat.pdos_atm#1(B)_wfc#2(p)',comments="#")
pdos_n1s = np.genfromtxt('hBN_1l_PBE_vdW_DOS.dat.pdos_atm#2(N)_wfc#1(s)',comments="#")
pdos_n1p = np.genfromtxt('hBN_1l_PBE_vdW_DOS.dat.pdos_atm#2(N)_wfc#2(p)',comments="#")
