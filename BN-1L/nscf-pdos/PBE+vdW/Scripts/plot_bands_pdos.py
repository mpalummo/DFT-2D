...
with open('../../bands/PBE+VdW/Ref/Bande_hBN_1L_PBE_vdW.dat.gnu', 'r') as file:
...
dos_B_p = np.genfromtxt('hBN_1l_PBE_vdW_DOS.dat.pdos_atm#1(B)_wfc#2(p)',comments="#")
dos_N_p = np.genfromtxt('hBN_1l_PBE_vdW_DOS.dat.pdos_atm#2(N)_wfc#2(p)',comments="#")
...
plt.savefig('Bands-pdos_hBN_1L_PBE_vdW.png', format='png')
plt.show()
