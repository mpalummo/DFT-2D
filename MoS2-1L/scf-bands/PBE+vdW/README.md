...
At the end you should have  MoS2_1L.scf.out MoS2_1L.bands.out bands.out and the corresponding files of the simulations performed with SOC that are called 
MoS2_1L.scf_wsoc.out MoS2_1L.bands_wsoc.out bands_wsoc.out
...
At the end you should have two files Bands_MoS2_1L_PBE-vdW_nSOC.png and Bands_MoS2_1L_PBE-vdW_wSOC.png in a png format 
